...
public class ProjectByIdTests {
    ...
    public void setup() {
        ...
        projects.add(APIProjectMethods.createProject("ProjectByTest Test Project", 1));
        projects.add(APIProjectMethods.createProject("ProjectByTest delete Test Project", 2));
